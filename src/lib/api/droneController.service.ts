...
import {DroneControllerServiceInterface} from './droneController.serviceInterface';
...
export class DroneControllerService implements DroneControllerServiceInterface {
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public create(droneDto: DroneDto, observe?: 'body', reportProgress?: boolean, options?: {
    httpHeaderAccept?: 'application/json',
    context?: HttpContext
  }): Observable<DroneDto>;

  public create(droneDto: DroneDto, observe?: 'response', reportProgress?: boolean, options?: {
    httpHeaderAccept?: 'application/json',
    context?: HttpContext
  }): Observable<HttpResponse<DroneDto>>;

  public create(droneDto: DroneDto, observe?: 'events', reportProgress?: boolean, options?: {
    httpHeaderAccept?: 'application/json',
    context?: HttpContext
  }): Observable<HttpEvent<DroneDto>>;

  public create(droneDto: DroneDto, observe: any = 'body', reportProgress: boolean = false, options?: {
    httpHeaderAccept?: 'application/json',
    context?: HttpContext
  }): Observable<any> {
  ...
  public get(id: number, observe: any = 'body', reportProgress: boolean = false, options?: {
    ...
    let localVarPath = `/api/drone/${this.configuration.encodeParam({
      name: "id",
      value: id,
      in: "path",
      style: "simple",
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public update(id: number, droneDto: DroneDto, observe?: 'body', reportProgress?: boolean, options?: {
    httpHeaderAccept?: 'application/json',
    context?: HttpContext
  }): Observable<DroneDto>;

  public update(id: number, droneDto: DroneDto, observe?: 'response', reportProgress?: boolean, options?: {
    httpHeaderAccept?: 'application/json',
    context?: HttpContext
  }): Observable<HttpResponse<DroneDto>>;

  public update(id: number, droneDto: DroneDto, observe?: 'events', reportProgress?: boolean, options?: {
    httpHeaderAccept?: 'application/json',
    context?: HttpContext
  }): Observable<HttpEvent<DroneDto>>;

  public update(id: number, droneDto: DroneDto, observe: any = 'body', reportProgress: boolean = false, options?: {
    httpHeaderAccept?: 'application/json',
    context?: HttpContext
  }): Observable<any> {
    if (id === null || id === undefined) {
