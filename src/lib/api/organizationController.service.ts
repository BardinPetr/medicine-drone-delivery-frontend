...
import {OrganizationControllerServiceInterface} from './organizationController.serviceInterface';
...
export class OrganizationControllerService implements OrganizationControllerServiceInterface {
  ...
  public _delete(id: number, observe: any = 'body', reportProgress: boolean = false, options?: {
    ...
    let localVarPath = `/api/organization/${this.configuration.encodeParam({
      name: "id",
      value: id,
      in: "path",
      style: "simple",
  ...
  public audit(observe?: 'body', reportProgress?: boolean, options?: {
    ...
    context?: HttpContext
  }): Observable<Array<AuditLogEntryOrganization>>;

  public audit(observe?: 'response', reportProgress?: boolean, options?: {
    httpHeaderAccept?: 'application/json',
    context?: HttpContext
  }): Observable<HttpResponse<Array<AuditLogEntryOrganization>>>;

  public audit(observe?: 'events', reportProgress?: boolean, options?: {
    httpHeaderAccept?: 'application/json',
    context?: HttpContext
  }): Observable<HttpEvent<Array<AuditLogEntryOrganization>>>;
