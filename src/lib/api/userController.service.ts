...
import {UserControllerServiceInterface} from './userController.serviceInterface';
...
export class UserControllerService implements UserControllerServiceInterface {
   ...
   */
  public get(observe?: 'body', reportProgress?: boolean, options?: {
    httpHeaderAccept?: 'application/json',
    context?: HttpContext
  }): Observable<User>;

  public get(observe?: 'response', reportProgress?: boolean, options?: {
    httpHeaderAccept?: 'application/json',
    context?: HttpContext
  }): Observable<HttpResponse<User>>;

  public get(observe?: 'events', reportProgress?: boolean, options?: {
    httpHeaderAccept?: 'application/json',
    context?: HttpContext
  }): Observable<HttpEvent<User>>;

  public get(observe: any = 'body', reportProgress: boolean = false, options?: {
    httpHeaderAccept?: 'application/json',
    context?: HttpContext
  }): Observable<any> {
  ...
  public verifyAdmin(id: number, observe: any = 'body', reportProgress: boolean = false, options?: {
    ...
    if (id === null || id === undefined) {
      throw new Error('Required parameter id was null or undefined when calling verifyAdmin.');
    }
    ...
    let localVarPath = `/api/user/${this.configuration.encodeParam({
      name: "id",
      value: id,
      in: "path",
      style: "simple",
